...
covid_df$date <- as.Date(covid_df, "%m/%d/%y")
...
ggplot(data=florida_df, aes(x=Month, y=Cases, group=1)) + geom_line()

## Add lines for New York and California to the plot
ggplot(data=florida_df, aes(x=Month, group=1)) +
